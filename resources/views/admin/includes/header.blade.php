                        ...
                        <div class="d-flex order-lg-2">
                            ...
                            <div class="dropdown d-md-flex main-header-notification flag-dropdown">
                                <a href="javascript:void(0);" class="nav-link icon text-center country-nav-link" data-bs-target="#country-selector" data-bs-toggle="modal">
                                    <img class="header-icons language" alt="" src="admin/assets/images/flags/us_flag.jpg">
                                </a>
                            </div>
                            <!-- SEARCH -->
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    ...
                                    <div class="header-dropdown-list cart-menu ps4 overflow-hidden">
                                        <a class="dropdown-item d-flex p-4" href="cart.php">
                                            <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="admin/assets/images/ecommerce/1.jpg"></span>
                                        ...
                                        <a class="dropdown-item d-flex p-4" href="cart.php">
                                            <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="admin/assets/images/ecommerce/2.jpg"></span>
                                            <div class="wp-60 cart-desc mt-1">
                                        ...
                                        <a class="dropdown-item d-flex p-4" href="cart.php">
                                            <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="admin/assets/images/ecommerce/3.jpg"></span>
                                            <div class="wp-60 cart-desc mt-1">
                                        ...
                                        <a class="dropdown-item d-flex p-4" href="cart.php">
                                            <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="admin/assets/images/ecommerce/4.jpg"></span>
                                            <div class="wp-60 cart-desc mt-1">
                                        ...
                                        <a class="dropdown-item d-flex p-4" href="cart.php">
                                            <span class="avatar avatar-lg br-5 me-3 align-self-center cover-image" data-bs-image-src="admin/assets/images/ecommerce/5.jpg"></span>
                                            <div class="wp-60 cart-desc mt-1">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow" data-bs-popper="none"> 
                                    ...
                                    <div class="message-menu ps2 overflow-hidden"> 
                                        <a class="dropdown-item d-flex" href="chat.php"> 
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="admin/assets/images/users/1.jpg" style="background: url(&quot;admin/assets/images/users/1.jpg&quot;) center center;"></span> 
                                            <div class="wd-90p"> 
                                                <div class="d-flex"> 
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.php"> 
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="admin/assets/images/users/15.jpg" style="background: url(&quot;admin/assets/images/users/15.jpg&quot;) center center;">
                                            </span> 
                                            <div class="wd-90p"> 
                                                <div class="d-flex"> 
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.php"> 
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="admin/assets/images/users/12.jpg" style="background: url(&quot;admin/assets/images/users/12.jpg&quot;) center center;">
                                            </span> 
                                            <div class="wd-90p"> 
                                                <div class="d-flex"> 
                                        ...
                                        <a class="dropdown-item d-flex" href="chat.php"> 
                                            <span class="avatar avatar-md brround me-3 align-self-center cover-image" data-bs-image-src="admin/assets/images/users/4.jpg" style="background: url(&quot;admin/assets/images/users/4.jpg&quot;) center center;">
                                            </span> 
                                            <div class="wd-90p"> 
                                                <div class="d-flex"> 
                            ...
                            <div class="dropdown d-md-flex profile-1">
                                <a href="#" data-bs-toggle="dropdown" class="nav-link pe-2 leading-none d-flex animate">
                                    <span>
                                        <img src="admin/assets/images/faces/6.jpg" alt="profile-user"
